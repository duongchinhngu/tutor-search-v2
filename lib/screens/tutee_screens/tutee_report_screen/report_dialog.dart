...
Future showReportDialogForTutee(BuildContext context, int enrollId) {
  return showDialog(
      context: context,
      builder: (context) => Dialog(
            ...
            child: TuteeReportDialog(
              enrollId: enrollId,
            ),
          ));
}

class TuteeReportDialog extends StatefulWidget {
  final int enrollId;

  const TuteeReportDialog({Key key, this.enrollId}) : super(key: key);
  @override
  _TuteeReportDialogState createState() => _TuteeReportDialogState();
}

class _TuteeReportDialogState extends State<TuteeReportDialog> {
                    ...
                    onTap: () async {
                      if (formKey.currentState.validate()) {
                        ...
                        if (selectedReportType == null) {
                          ...
                          //send report
                          final TuteeReport tuteeReport =
                              TuteeReport.contructor(
                          ...
                          //
                          await TuteeReportRepository()
                              .postTuteeReport(tuteeReport);
                          //
              ...
              child: BlocProvider(
                ...
                child: BlocBuilder<ReportTypeCubit, ReportTypeState>(
                  builder: (context, state) {
                    ...
                    reportTypeCubit.getReportType(authorizedTutee.roleId);
                    //
