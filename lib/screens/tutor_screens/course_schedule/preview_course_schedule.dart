...
import 'package:tutor_search_system/screens/tutor_screens/create_course_screens/tmp_variables.dart' as tmp;
            ...
            onPressed: () {
              setState(() {
                ...
                if (check == 0) {
                  ...
                  print(tmp.listSchedule.length);
             
                  tmp.listOutcome = widget.listOutcome;
           
                  tmp.listPlan = widget.listPlan;
          
                  tmp.selectedSubject = widget.subject;
                  tmp.listweek = widget.listweek;
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) => CreateCourseScreen(
                              listCourseDetail: tmp.listSchedule,
                              selectedSubject: tmp.selectedSubject,
                              listWeek: tmp.listweek,
                              listPlan: tmp.listPlan,
                              listOutcome: tmp.listOutcome,
                            )),
                  );
                }
              });
