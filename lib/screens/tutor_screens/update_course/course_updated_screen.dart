...
class CourseUpdatedScreen extends StatefulWidget {
  @override
  _CourseUpdatedScreenState createState() =>
      _CourseUpdatedScreenState();
}

class _CourseUpdatedScreenState
    extends State<CourseUpdatedScreen> {
