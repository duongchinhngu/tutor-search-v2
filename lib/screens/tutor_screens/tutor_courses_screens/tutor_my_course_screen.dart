            ...
            Container(
              ...
              child: ListView(
                ...
                children: <Widget>[
                  ...
                  buildCourseStatusCard(1, CourseConstants.DENIED_STATUS),
                  buildCourseStatusCard(2, CourseConstants.PENDING_STATUS),
                  buildCourseStatusCard(3, CourseConstants.ACTIVE_STATUS),
                  buildCourseStatusCard(4, CourseConstants.ONGOING_STATUS),
                  buildCourseStatusCard(5, CourseConstants.INACTIVE_STATUS),
                ],
              ),
            ),
            CourseListView(
