...
class CourseScheduleScreenDraft extends StatefulWidget {
  final int numberOfWeek;

  const CourseScheduleScreenDraft({Key key, @required this.numberOfWeek})
      : super(key: key);
...
class _CourseScheduleScreenState extends State<CourseScheduleScreenDraft> {
  int weekIndex = 1;
